...
BEGIN 
DELETE from song_entry where (song_name = song_entry_ and artist_name = artist_entry_ 
	and album_name = album_entry_ and genre_name = genre_entry_);
END $$
DELIMITER ;

/*
call delete_entry_proc('Uptown Funk', 'Bruno Mars', '');
